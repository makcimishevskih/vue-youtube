<template>
  <section class="flex items-center h-20 border-b-2 bg-white fixed w-full z-30 bg-opacity-95">
    <div class="w-1/3 flex mr-4 items-center px-4">
      <button class="px-2 mr-2 hover:text-gray-500">
        <svg
          class="w-6 h-6"
          fill="none"
          viewBox="0 0 22 22"
      ...
      <RouterLink to="/">
        <svg class="w-20" viewBox="409.289 277.787 512 114.301" xmlns="http://www.w3.org/2000/svg">
          <g
            viewBox="0 0 90 20"
    ...
    <nav class="w-full flex items-center justify-end text-gray-400">
      <div class="flex w-full justify-end">
        <input
          class="w-full py-1 max-w-sm border border-gray-200 focus:border-cyan-300 rounded-md px-3 border-r-0 rounded-r-none self-end"
          type="search"
          name="search"
          placeholder="Search..."
        />
        <button
          class="px-6 py-1 bg-gray-50 flex items-center border border-gray-200 hover:bg-gray-300 border-l-0"
        >
          <svg
            class="w-4 h-4"
            viewBox="0 0 24 24"
      ...
      <button class="ml-4 hover:text-gray-700">
        <svg
          class="w-5 h-5"
          viewBox="0 0 24 24"
          xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="w-1/3 flex items-center justify-end gap-2 px-4 text-gray-400">
